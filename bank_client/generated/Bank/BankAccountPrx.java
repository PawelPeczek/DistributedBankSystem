...
{
    default float getState()
        throws AuthorizationException
    {
        return getState(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default float getState(java.util.Map<String, String> context)
        throws AuthorizationException
    {
        try
        {
    ...
    default java.util.concurrent.CompletableFuture<Float> getStateAsync()
    {
        return _iceI_getStateAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Float> getStateAsync(java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Float> _iceI_getStateAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Float> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getState", null, sync, _iceE_getState);
    ...
    default float putMoney(float value)
        throws AuthorizationException,
            OperationException
    {
        return putMoney(value, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default float putMoney(float value, java.util.Map<String, String> context)
        throws AuthorizationException,
            OperationException
    {
        try
        {
            return _iceI_putMoneyAsync(value, context, true).waitForResponseOrUserEx();
        }
        catch(AuthorizationException ex)
        {
            throw ex;
    ...
    default java.util.concurrent.CompletableFuture<Float> putMoneyAsync(float value)
    {
        return _iceI_putMoneyAsync(value, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Float> putMoneyAsync(float value, java.util.Map<String, String> context)
    {
        return _iceI_putMoneyAsync(value, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Float> _iceI_putMoneyAsync(float iceP_value, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Float> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "putMoney", null, sync, _iceE_putMoney);
    ...
    /** @hidden */
    static final Class<?>[] _iceE_putMoney =
    {
        AuthorizationException.class,
        OperationException.class
    };

    default float withdrawMoney(float value)
        throws AuthorizationException,
            OperationException
    {
        return withdrawMoney(value, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default float withdrawMoney(float value, java.util.Map<String, String> context)
        throws AuthorizationException,
            OperationException
    {
        try
        {
            return _iceI_withdrawMoneyAsync(value, context, true).waitForResponseOrUserEx();
        }
        catch(AuthorizationException ex)
        {
            throw ex;
    ...
    default java.util.concurrent.CompletableFuture<Float> withdrawMoneyAsync(float value)
    {
        return _iceI_withdrawMoneyAsync(value, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Float> withdrawMoneyAsync(float value, java.util.Map<String, String> context)
    {
        return _iceI_withdrawMoneyAsync(value, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Float> _iceI_withdrawMoneyAsync(float iceP_value, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Float> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "withdrawMoney", null, sync, _iceE_withdrawMoney);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeFloat(iceP_value);
                 }, istr -> {
                     float ret;
    ...
    /** @hidden */
    static final Class<?>[] _iceE_withdrawMoney =
    {
        AuthorizationException.class,
        OperationException.class
    };
